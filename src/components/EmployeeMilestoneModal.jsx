                            ...
                            >
                              ...
                              <Box sx={{ mt: 4 }}>
                                ...
                                >
                                  ...
                                  >
                                    <AssignmentIcon /> Features to Implement (
                                  ...
                                  {canEdit && (
                                    <Button
                                      ...
                                      onClick={() => {
                                        ...
                                        setExpandedFeature({
                                          ...expandedFeature,
                                          [`${milestone.id}_${newFeature.id}`]: true,
                                        });
                                      }}
                                      sx={{
                                        borderRadius: 2,
                                                        ...
                                                        {feature.items.map(
                                                          (item, itemIndex) => {
                                                            ...
                                                            if (
                                                              ...
                                                              console.log(
                                                                "Task Assignment Check (DragDrop):",
                                                                {
                                                                  itemId:
                                                                    item.id,
                                                                  assignedTo:
                                                            ...
                                                            if (
                                                              ...
                                                              console.log(
                                                                "Can Complete Task Check (DragDrop):",
                                                                {
                                                                  itemId:
                                                                    item.id,
                                                                  itemText:
                                ...
                                {milestone.features.length === 0 ? (
                                  ...
                                  >
                                    ...
                                    <Typography
                                      ...
                                      color="text.secondary"
                                    >
                                      This milestone doesn't have any features
                                      defined.
                                    </Typography>
                                  </Paper>
                                ) : (
                                                ...
                                                >
                                                  {feature.items.map(
                                                    (item, itemIndex) => {
                                                      ...
                                                      // Debug logging for task assignment check
                                                      console.log(
                                                        "Task Assignment Check (Read-Only):",
                                                        {
                                                          itemId: item.id,
                                                          itemText: item.text,
                                                          assignedTo:
